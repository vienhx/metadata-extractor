...
/**
 * Sources: http://www.rfc-editor.org/rfc/rfc4867.txt (https://tools.ietf.org/html/rfc4867)
 *
 * @author Vien Hong
 */
public class AmrReader
{
    ...
    {
        AmrDirectory directory = new AmrDirectory();
...
//                case (0):
//                    directory.setString(AmrDirectory.TAG_ID, "MPEG-2.5");
//                    id = 2.5;
//                    throw new ImageProcessingException("MPEG-2.5 not supported.");
//                case (2):
//                    directory.setString(AmrDirectory.TAG_ID, "MPEG-2");
//                    id = 2;
//                    break;
//                case (3):
//                    directory.setString(AmrDirectory.TAG_ID, "MPEG-1");
//                    id = 1;
//                    break;
//                default:
//            }
...
//            switch (layer) {
//                case(0):
//                    directory.setString(AmrDirectory.TAG_LAYER, "Not defined");
//                    break;
//                case(1):
//                    directory.setString(AmrDirectory.TAG_LAYER, "Layer III");
//                    break;
//                case(2):
//                    directory.setString(AmrDirectory.TAG_LAYER, "Layer II");
//                    break;
//                case(3):
//                    directory.setString(AmrDirectory.TAG_LAYER, "Layer I");
//                    break;
//                default:
//            }
//
...
//                directory.setInt(AmrDirectory.TAG_BITRATE, setBitrate(bitrate, layer, id));
//
...
//            switch (mode){
//                case(0):
//                    directory.setString(AmrDirectory.TAG_MODE, "Stereo");
//                    break;
//                case(1):
//                    directory.setString(AmrDirectory.TAG_MODE, "Joint stereo");
//                    break;
//                case(2):
//                    directory.setString(AmrDirectory.TAG_MODE, "Dual channel");
//                    break;
//                case(3):
//                    directory.setString(AmrDirectory.TAG_MODE, "Mono");
//                    break;
//                default:
//            }
//
...
//            switch (copyright) {
//                case(0):
//                    directory.setString(AmrDirectory.TAG_COPYRIGHT, "False");
//                    break;
//                case(1):
//                    directory.setString(AmrDirectory.TAG_COPYRIGHT, "True");
//                    break;
//                default:
//            }
//
...
//            switch (emphasis) {
//                case (0):
//                    directory.setString(AmrDirectory.TAG_EMPHASIS, "none");
//                    break;
//                case (1):
//                    directory.setString(AmrDirectory.TAG_EMPHASIS, "50/15ms");
//                    break;
//                case (3):
//                    directory.setString(AmrDirectory.TAG_EMPHASIS, "CCITT j.17");
//                    break;
//                default:
//            }
//
//            int frameSize = ((setBitrate(bitrate, layer, id) * 1000) * 144) / frequency;
//            directory.setString(AmrDirectory.TAG_FRAME_SIZE, frameSize + " bytes");
//        } catch (IOException e) {
//            e.printStackTrace();
